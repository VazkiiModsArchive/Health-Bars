...
public class HealthBarsConfig extends Configuration {
	...
	private static String[] RGB_TO_GET = new String[]{
		"barOutline", "barBackground", "barNeutral", "barAggro", "barPoisoned"
	};
	
	private static String[] RGB_NAMES = new String[]{
		"Bar Outline", "Bar Background", "Bar Neutral Status", "Bar Aggro Status", "Bar Poisoned Status"
	};
